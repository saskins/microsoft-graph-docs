...
description: "Describes workbookRangeView: itemAt, which is one of the following permissions required to call this API. To learn more, including how to choose permissions, see Permissions."
